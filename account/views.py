...
class SendPasswordResetEmailView(APIView):
    @swagger_auto_schema(
        ...
        responses={
            200: openapi.Response('Password reset email sent!', examples={'application/json': {"message": "Password reset email sent!"}}),
            404: openapi.Response('User with this email does not exist.', examples={'application/json': {"error": "User with this email does not exist."}})
        }
    )
...
class ResetPasswordView(APIView):
    @swagger_auto_schema(
        ...
        responses={
            200: openapi.Response('Password reset successful!', examples={'application/json': {"message": "Password reset successful!"}}),
            400: openapi.Response('Invalid or expired token.', examples={'application/json': {"error": "Invalid or expired token."}}),
            404: openapi.Response('Invalid user.', examples={'application/json': {"error": "Invalid user."}})
        }
    )
